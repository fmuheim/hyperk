...
for measurement in measurements:
    ...
    files_ped = [x for x in os.listdir('' + sys.argv[1] + '/' + measurement + '_ped') if x.endswith(sys.argv[2]+'.txt')]
    ...
    for file,file_ped in file_pairs:
        ...
        data_ped = open((''+sys.argv[1]+'/'+measurement+'_ped/'+file),'r').read()
    ...
    output_df    .to_pickle('' + sys.argv[1] + '/' + measurement + '_' + sys.argv[1]+'_'+sys.argv[2]+'.pkl')
    output_df_ped.to_pickle('' + sys.argv[1] + '/' + measurement + '_' + sys.argv[1]+'_'+sys.argv[2]+'_ped.pkl')
